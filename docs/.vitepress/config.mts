...
export default defineConfig({
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/zon-blogs/zonky.blog' },
      { icon: {
      ...
      }, link: 'https://juejin.cn/user/1600490922582398' }
    ],
    ...
    // }
    editLink: {
      pattern: 'https://github.com/zon-blogs/zonky.blog/tree/main/docs/src/:path',
